...
$paciente = $conn->query("SELECT * FROM pacientes WHERE deleted = 1 ORDER BY idpacientes ASC")->fetchAll(PDO::FETCH_OBJ);
...
'../../seguridad/controllers/logout.php','../../seguridad/routes/perfil.php',
  '../../recursoshumanos/','../../suministro/','../../contabilidad/','../../citasmedicas/','../index.php','../../seguridad/',6);
?>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">PACIENTES DADOS DE BAJA</h1>
