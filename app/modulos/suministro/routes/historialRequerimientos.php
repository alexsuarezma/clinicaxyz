...
$orden = $conn->query("SELECT * FROM orden_compra WHERE estado='aceptado' OR estado='espera' ORDER BY fecha_pedido DESC")->fetchAll(PDO::FETCH_OBJ);
...
<html lang="es">
  <head>
    ...
    <title> Contabilidad | Ordenes de Requerimiento</title>
